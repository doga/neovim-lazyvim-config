-- Uncomment only one color scheme

--return require("plugins.colorschemes.cobalt")
...
--return require("plugins.colorschemes.blue-moon")
--return require("plugins.colorschemes.eidolon")
--return require("plugins.colorschemes.nord")
